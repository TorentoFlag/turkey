...
CREATE UNIQUE INDEX "catalog_protocol_operations_site_idempotency_idx" ON "catalog_protocol_operations" USING btree ("site_key","idempotency_key");--> statement-breakpoint
CREATE UNIQUE INDEX "catalog_protocol_operations_site_request_idx" ON "catalog_protocol_operations" USING btree ("site_key","request_id");--> statement-breakpoint
